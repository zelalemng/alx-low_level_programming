...
/**
 * shash_table_creates a sorted hash table
 ...
 */
int shsh_table_set(shash_table_t *ht, const char *key, const char *value)
{
 ...
 * @key: key to the data
 *
 * Return: the value associated with key, or NULL on failire
 */
